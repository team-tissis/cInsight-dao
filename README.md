...
- cInsight DAO では、会員証として 焚き火 SBT を発行します。さらに、この SBT は、DAO への貢献度に応じて動的に変化します。
...
- そこで、cInsight DAO では、メンバーの行動履歴が全てオンチェーンに記録されていることに着目し、この記録から人間関係によるバイアスを軽減することを目指しています。
